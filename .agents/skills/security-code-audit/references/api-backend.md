...
> **Scope: static (white-box) code review — what to _read_ and _grep_ for in source.** To _test_
...
_Dynamic testing of these → `access-control-testing`. In code, look for:_
...
_Dynamic testing (ATO, reset poisoning, OAuth/JWT/MFA) → `authentication-testing`. In code, look for:_
