...
each endpoint you discovered above. Below are the checks _unique to APIs_:
...
parameter pollution. _(BOLA/BFLA/mass-assignment → `access-control-testing`.)_
